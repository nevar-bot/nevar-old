...
module.exports = class {
    ...
    async dispatch(guildScheduledEvent) {
        ...
        const logText =
            " ** " + guildScheduledEvent.name + " wurde gelöscht**\n\n" +
        ...
        return guild.logAction(logText, "guild", this.client.emotes.events.event.delete, "error", guildScheduledEvent.coverImageURL());
    }
}