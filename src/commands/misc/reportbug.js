...
class Reportbug extends BaseCommand {
    ...
    async reportBug(bug){
        ...
        const successEmbed = this.client.generateEmbed("{0} Danke für deine Meldung! Wir werden uns so schnell wie möglich darum kümmern.", null, "success", this.client.emotes.flags.BugHunterLevel1);
        ...
        const supportEmbed = this.client.generateEmbed("{0} ({1}) hat einen Fehler gemeldet: {2}", "information", "warning", this.interaction.user.tag, this.interaction.user.id, bug);
